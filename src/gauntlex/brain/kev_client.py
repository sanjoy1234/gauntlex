...
Enriches the GAUNTLEX Breaker with CISA's authoritative feed of vulnerabilities
...
The feed is cached for the duration of a GAUNTLEX process — it's a ~4MB JSON
...
class KevClient:
    ...
    relevant to the current GAUNTLEX run. Returns formatted Breaker context.
