"""Init command — scaffold .gauntlex.yml with sensible defaults."""
...
def execute(domain: str = "owasp_top10", force: bool = False) -> InitResult:
    """
    Scaffold .gauntlex.yml with sensible defaults for the given domain.

    Args:
        domain: Policy domain to activate (default: owasp_top10)
        force: Overwrite existing .gauntlex.yml

    Returns:
        InitResult indicating if file was created or skipped
    """
    from gauntlex.config import DEFAULT_CONFIG_YAML
