"""
ARS Leaderboard — processes SWE-bench agent patch outputs through GAUNTLEX Breaker
...
Usage:
  from gauntlex.leaderboard.engine import LeaderboardEntry, build_leaderboard, render_leaderboard_html
"""
