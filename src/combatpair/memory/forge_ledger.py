...
Writes one Markdown file per attack into:
  .combatpair/vault/<CWE-XXX>/<run_id>-<attack_id>.md
...
_DEFAULT_VAULT_DIR = Path(".combatpair/vault")
...
class ForgeLedger:
    ...
    def write_entry(
        ...
        # File lock prevents corruption when multiple combatpair runs write concurrently
        import fcntl
