...
Enriches the COMBATPAIR Breaker with live CVE intelligence from NIST's
...
class NvdClient:
    ...
    intelligence context for the COMBATPAIR Breaker agent.

    All calls are best-effort — a network failure or API error never
    blocks a COMBATPAIR run; the Breaker simply runs without live NVD context.
    """
