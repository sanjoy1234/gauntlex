...
COMBATPAIR is NOT an MCP server (incompatible 60-90s runtime with MCP's sub-second
...
DIA is configured under mcp_servers: in .combatpair.yml.
...
class DomainIntelligenceAdapter:
    ...
    def from_config(cls, config: "AppConfig") -> "DomainIntelligenceAdapter":  # noqa: F821
        """Build DIA from the mcp_servers block in .combatpair.yml."""
