...
def render_findings_summary(report: dict) -> str:
    ...
    lines = ["## COMBATPAIR Security Findings", ""]
...
def render_markdown(report: dict) -> str:
    ...
    lines += [
        ...
        f"*Generated by [COMBATPAIR](https://github.com/sanjoy1234/combatpair)*",
    ]
...
<title>COMBATPAIR Resilience Report — {report['run_id']}</title>
<style>
...
<body>
<header>
  <h1>⚔️ COMBATPAIR Resilience Report</h1>
        ...
        "runs": [
            {
                "tool": {
                    "driver": {
                        "name": "COMBATPAIR",
                        "version": "0.1.0",
                        "informationUri": "https://github.com/sanjoy1234/combatpair",
...
def render_junit_xml(report: dict) -> str:
    ...
    playbook = report.get("playbook_version", "combatpair")
