"""
Combat Dashboard — FastAPI web UI for COMBATPAIR.

Optional install: pip install combatpair-ai[ui]
Launch:           combatpair dashboard --port 8080
...
def _require_fastapi():
    if not _FASTAPI_AVAILABLE:
        raise RuntimeError(
            ...
            "Install with: pip install combatpair-ai[ui]"
        )
...
def create_app(config: AppConfig | None = None):  # returns FastAPI when installed
    ...
    # COMBATPAIR_CONFIG_PATH is set by `combatpair dashboard --config ...` / `combatpair serve
    # --config ...` — needed because uvicorn calls this factory with no arguments, so an
    # explicit --config can't be passed through directly.
    cfg = config or AppConfig.load(os.environ.get("COMBATPAIR_CONFIG_PATH"))
    runs_dir = cfg.reports_dir.parent / "runs"
    app = FastAPI(title="COMBATPAIR Combat Dashboard", version="0.1.0")
    ...
    @app.get("/health")
    async def health():
        return {"status": "ok", "service": "combatpair-dashboard"}
  ...
  <div style="background:#FEF2F2;border:1px solid #FCA5A5;border-radius:10px;padding:14px 16px;margin-bottom:20px;font-size:12px;color:#991B1B;line-height:1.6">
    &#x26A0;&#xFE0F; <strong>No COMBATPAIR project found</strong> — nothing remembered from a
    previous run either. Reports are being read from {cfg.reports_dir}.
    Fix: run any <code>combatpair</code> command inside your project once, then this will
    resolve automatically from anywhere.
  </div>"""
        html = f"""<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>COMBATPAIR — System Status</title>
<style>
...
<div class="card">
  <h1><span class="dot"></span> COMBATPAIR — System Status</h1>
  <div class="sub">Adversarial Co-Generation Engine &mdash; all systems operational</div>
  {no_project_banner}
  <div class="row"><span class="lbl">Service</span><span class="val ok">&#x2705; combatpair-dashboard</span></div>
...
<html lang="en"><head><meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>COMBATPAIR — JSON API Reference</title>
<style>
...
<header>
  <h1>&#x26A4; COMBATPAIR &mdash; JSON API Reference</h1>
...
<div class="ep">
  ...
  <div class="desc">Raw health check. Returns <code>{{"status":"ok","service":"combatpair-dashboard"}}</code>. Used by load balancers and monitoring systems.</div>
...
<html lang="en"><head><meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>COMBATPAIR — MCP Tools</title>
<style>
*{{box-sizing:border-box;margin:0;padding:0}}
...
<header>
  <h1>&#x1F9E0; COMBATPAIR &mdash; MCP Tools</h1>
  <p>{len(tools)} tools available &nbsp;&bull;&nbsp; Works with Claude Code, Cursor, Windsurf, GitHub Copilot, Codex</p>
</header>
<div class="body">
<a class="back" href="/">&#x2190; Back to Dashboard</a>
<div class="intro">
  <strong>Model Context Protocol (MCP)</strong> lets your AI coding assistant call COMBATPAIR directly from chat.
  Run <code style="background:#EFF6FF;padding:2px 6px;border-radius:4px;font-size:12px">combatpair integrate</code> to wire it up automatically,
  ...
  The stdio transport (<code style="background:#EFF6FF;padding:2px 6px;border-radius:4px;font-size:12px">combatpair mcp-server</code>) is recommended for local development.
</div>
{cards_html}
</div></body></html>"""
        return HTMLResponse(html)
...
def _load_active_runs(runs_dir: Path) -> list[dict]:
    ...
    liveness check `combatpair status` uses, so the dashboard and CLI always agree."""
...
def _render_index(reports: list[dict], cfg: AppConfig, active_runs: list[dict] | None = None) -> str:
    ...
    empty_html = "" if reports else (
        ...
        '<code class="empty-cmd">combatpair run --issue examples/demo_issue.md --pretty</code>'
        '</div>'
    )
    table_html = ""
    if reports:
    ...
    # normally the dashboard remembers whatever project you last ran combatpair in.
    no_project_html = ""
    if cfg.config_source is None:
        no_project_html = f"""
<div class="runs-card" style="border-color:#FCA5A5;margin-bottom:20px">
  ...
  <div style="padding:16px 20px;font-size:13px;color:#374151;line-height:1.7">
    ...
    a COMBATPAIR project, and nothing was remembered from a previous run on this machine either.
    It's reading (and will only ever find reports in) <code class="run-code">{cfg.reports_dir}</code>.<br><br>
    <strong>Fix:</strong> run any <code class="run-code">combatpair</code> command inside your project once
    (e.g. <code class="run-code">combatpair status</code>) — after that, <code class="run-code">combatpair dashboard</code>
...
<title>COMBATPAIR Combat Dashboard</title>
<style>{css}</style>
</head>
<body>
...
<div class="hero">
  <div class="hero-inner">
    ...
    <div class="hero-text">
      ...
      <p>COMBATPAIR generates <strong>code and attacks simultaneously</strong> — the Builder writes,
...
<div class="pipeline-card">
  <div class="card-hdr">&#x26A1; How COMBATPAIR Works &mdash; Live Pipeline</div>
...
<div class="cli-card">
  <div class="cli-hdr">
    ...
    <span class="cli-title">Terminal &mdash; COMBATPAIR CLI Quick Start</span>
  </div>
  <div class="cli-body">
    <div class="cli-block">
      <div class="cli-block-title">&#x1F680; Run adversarial testing</div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">examples/demo_issue.md</span> <span class="cli-flag">--pretty</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">https://github.com/org/repo/issues/42</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">./src/</span> <span class="cli-flag">--intent</span> <span class="cli-arg">PROJ-123</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--rounds</span> <span class="cli-arg">3</span> <span class="cli-flag">--format</span> <span class="cli-arg">sarif</span></span></div>
    </div>
    <div class="cli-block">
      <div class="cli-block-title">&#x1F527; Setup &amp; Integration</div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair integrate</span> <span class="cli-arg">all</span> <span class="cli-comment"># Claude Code, Cursor, Copilot, Codex, Windsurf</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair integrate</span> <span class="cli-arg">github-actions</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair findings</span> <span class="cli-comment"># last run vulnerability report</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair dashboard</span> <span class="cli-flag">--port</span> <span class="cli-arg">8080</span> <span class="cli-comment"># this UI</span></span></div>
    </div>
    <div class="cli-block">
      <div class="cli-block-title">&#x1F4E6; Multi-repo testing</div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">https://github.com/axios/axios</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">https://github.com/pallets/flask</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--issue</span> <span class="cli-arg">https://github.com/gin-gonic/gin</span></span></div>
    </div>
    <div class="cli-block">
      <div class="cli-block-title">&#x1F3C6; Output formats</div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--format</span> <span class="cli-arg">html</span> <span class="cli-comment"># exec report</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--format</span> <span class="cli-arg">sarif</span> <span class="cli-comment"># SAST tools</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair run</span> <span class="cli-flag">--format</span> <span class="cli-arg">junit</span> <span class="cli-comment"># CI pipelines</span></span></div>
      <div class="cli-line"><span class="cli-prompt">$</span><span><span class="cli-cmd">combatpair findings</span> <span class="cli-flag">--format</span> <span class="cli-arg">md</span> <span class="cli-comment"># PR comment</span></span></div>
    </div>
  </div>
</div>

</div><!-- /main -->
<footer>COMBATPAIR Adversarial Co-Generation Engine &nbsp;&bull;&nbsp; Built by Sanjoy Ghosh &nbsp;&bull;&nbsp; Auto-refreshes every 30s</footer>
