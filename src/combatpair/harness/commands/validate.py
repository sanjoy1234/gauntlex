"""Validate command — programmatic API for combatpair validate + AVF gate."""
...
async def execute(
    ...
    from combatpair.policy.engine import list_available_domains

    cfg = AppConfig.load(config_path)
    checks: list[CheckResult] = []
    all_passed = True

    checks.append(CheckResult("Config loaded", True, ".combatpair.yml"))
