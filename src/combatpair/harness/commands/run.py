"""Run command — programmatic API for combatpair run."""
...
async def execute(
    ...
    Args:
        ...
        config_path: Path to .combatpair.yml (None = auto-detect)
    ...
    from combatpair.output.report import generate_run_id, build_report, save_report
    from combatpair.policy.engine import load_domains, combine_policy_context, list_available_domains
    from combatpair.memory.forge import KnowledgeForge
    from combatpair.brain.language_profiles import attack_context_for_spec
    from combatpair.brain.domain_intelligence import DomainIntelligenceAdapter
